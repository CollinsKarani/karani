					...
					<div class="row"> 
						<div class="col-lg-12"> 
							<form class="form-horizontal" role="form" method="post" action="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/save">
								...
								<?php echo select_join_group('namaCategory','idCategory,namaCategory,kodeInduk','catalog_category','kodeInduk','kodeInduk','Kode Induk',array('kodeInduk'=>0,'kodeInduk'!= @$getCategory[0]['idCategory']),(@$getCategory[0]['kodeInduk']) ? @$getCategory[0]['kodeInduk'] : set_value('kodeInduk'),'','Pilih Data') ?>
