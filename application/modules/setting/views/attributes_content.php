									...
									foreach ($data as $key => $value) {
										...
										<tr>
											...
											<td style="vertical-align:middle;" class="text-center">
												<a href="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/detail?u=<?php echo $value['idPAttribute'] ?>">
												...
												<a href="<?php echo base_url() ?>index.php/<?php echo getModule() ?>/<?php echo getController() ?>/add/<?php echo $value['idPAttribute'] ?>">
													<button class="btn btn-icon waves-effect waves-light btn-primary btn-xs m-b-5" data-attr="<?= $value['idPAttribute'] ?>"><i class="fa fa-pencil"></i></button>
												</a>
												<button class="btn btn-icon waves-effect waves-light btn-danger btn-xs m-b-5 sa-params" data-id="<?= $value['idPAttribute'] ?>"><i class="fa fa-trash"></i></button>
											</td>
										</tr>
										<?php
									}
